...
varnames(::typeof(cons2cons), ::HyperbolicAdvectionDiffusionEquations1D) = @SVector ["scalar", "q1"]
varnames(::typeof(cons2prim), ::HyperbolicAdvectionDiffusionEquations1D) = @SVector ["scalar", "q1"]
